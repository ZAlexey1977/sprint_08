// Task 01
// Создайте объект obj_01, который содержит свойство name равное 'Gedeon', поле name2 равное 'Richter', поле year равно 1944.
// Самостоятельно задайте типы данных для данных свойств. Выведите объект в консоль.
...
// Task 02
// Создайте объект obj_02 с полями: role, email, vip. Поле role содержит строку 'admin',
// поле email содержит 'ppprrr@mail.ua', а поле vip укажите как необязательное, числовое. Выведите объект в консоль.
...
// Task 03
// Создан объект obj_03. Напишите функцию, которая возвращает строку, где значения объекта перечислены через пробел.
// Тип функции укажите самостоятельно. Коммента
...
// Task 04
//  Создан объект obj_03. Напишите функцию, которая возвращает строку, где ключи объекта перечислены через пробел.
// Тип функции укажите самостоятельно.

const f_04 = (): string => {
  let arr: string[] = Object.keys(obj_03);
...
// Task 05
// Создан объект obj_05. Напишите функцию, которая возвращает строку характеристик (specifications)
// с разделителем между характеристиками через подчеркивание. Тип функции укажите самостоятельно.
...
// разделителем между значениями через подчеркивание. Тип функции укажите самостоятельно. Перебор цикла выполнять циклом for in.
...
// Task 15
// Функция получаем объект как аргумент, и возвращает true,
// если есть хотя бы один удар (hit) по силе больший чем 5 и false в противном случае.
